...
<style-specification id="docbook" 
    use="af ca cs da de el en es et fi fr hu id it ja ko nl no pl pt ptbr ro ru sk sl sr sv tr zhcn zhtw dbparam dblib">

<style-specification-body>

;; $Id: docbook.dsl,v 1.1 2001/10/09 18:50:38 jfilby Exp $
;;
