...
*/
	...
	$getbuilds_langres["browsesvn"] = "Naryti SVN saugykla";
	$getbuilds_langres["cia"] = "iureti veliausius SVN iraus CIA.vc puslapyje";
	$getbuilds_langres["buildbot_status"] = "BuildBot'o bukle";
	$getbuilds_langres["buildbot_web"] = "BuildBot'o Web sasaja";
	$getbuilds_langres["browsebuilds"] = "Naryti visas sukurtas laidas";
	
	$getbuilds_langres["downloadrev"] = "Parsisiusti ReactOS SVN laidas";
	$getbuilds_langres["js_disclaimer"] = 'JavaScript turi buti ijungtas jusu narykleje, kad galetumete naudotis SVN bylu sarau.<br>Kitu atveju, jus galite parsisiusti SVN laidas <a href="http://svn.reactos.org/iso">cia</a>.';
	...
	$getbuilds_langres["gettinglist"] = "Iekoma bylu";
	...
	$getbuilds_langres["pleasewait"] = "Praome palaukti";
	
	$getbuilds_langres["nofiles"] 	 = "Laidai %s bylu nerasta!";
	$getbuilds_langres["invalidrev"] = "Neteisingas laidos numeris!";
	
	$getbuilds_langres["rangelimitexceeded"] = "Laidu skaicius negali viryti %s!";
?>
