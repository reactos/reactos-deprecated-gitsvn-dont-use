...
*/
	...
	$peoplemap_langres["filter_intro"] = "Нажмите флажок напротив группы пользователей, чтобы показать или скрыть их расположения с карты.";
	...
	$peoplemap_langres["mylocation_intro"] = "Здесь вы можете установить ваше расположение на карте. Вы можете сделать это одним из следующих способов:";
	...
	$peoplemap_langres["mylocation_marker_save_intro"] = "Нажмите кнопку для сохранения<br>вашего расположения.";
	$peoplemap_langres["mylocation_marker_save_button"] = "Сохранить мое расположение";
