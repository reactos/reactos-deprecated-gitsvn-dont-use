...
*/
	...
	$peoplemap_langres["add_fullname"] = "Imię i nazwisko";
	...
	$peoplemap_langres["mylocation_marker_intro"] = "Użyj Znacznika i przeciągnij go w odpowiednie miejsce na Mapie.";
	...
	$peoplemap_langres["mylocation_coordinates_invalid"] = "To nie są prawidłowe współrzędne!";
	$peoplemap_langres["mylocation_delete_intro"] = "Używając poniższego przycisku możesz usunąć Twoje położenie z Mapy.";
	...
	$peoplemap_langres["activatejs"] = "Musisz włączyć JavaScript aby korzystać z Mapy Osób!";
	$peoplemap_langres["unsupportedbrowser"] = "Mapa Osób nie jest wspierana przez Twoją przeglądarkę.";
	
	$peoplemap_langres["count1"] = "Pokazuję <strong>";
